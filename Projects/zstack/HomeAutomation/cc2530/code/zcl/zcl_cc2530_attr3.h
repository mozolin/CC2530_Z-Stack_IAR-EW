...
SimpleDescriptionFormat_t zclcc2530_SimpleDesc3 =
{
  cc2530_ENDPOINT_3,                //  int Endpoint;
 ...
 */
static zclGeneral_AppCallbacks_t zclcc2530_CmdCallbacks3 =
{
  zclcc2530_BasicResetCB,               // Basic Cluster Reset command
  NULL,                                   // Identify Trigger Effect command
  zclcc2530_OnOffCB3,                    // On/Off cluster commands
...
CONST zclAttrRec_t zclcc2530_Attrs3[] =
{
...
uint8 CONST zclcc2530_NumAttributes3 = ( sizeof(zclcc2530_Attrs3) / sizeof(zclcc2530_Attrs3[0]) );
